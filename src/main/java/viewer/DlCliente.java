...
public class DlCliente extends javax.swing.JDialog {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        List<Cliente> clientes = GUIManager.getInstance().getDomainManager().pesquisarCliente();
        GUIManager.getInstance().getReportManager().relComLista(clientes, "Cliente.jasper");
