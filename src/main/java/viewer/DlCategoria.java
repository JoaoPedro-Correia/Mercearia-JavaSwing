...
public class DlCategoria extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlCategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlCategoria dialog = new DlCategoria(new javax.swing.JFrame(), true);
